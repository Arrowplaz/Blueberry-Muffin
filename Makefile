...
default: DatabaseServer.class FrontEndServer.class Client.class TestClient.class
...
TestClient.class: TestClient.java
	javac -Xlint:unchecked -cp $(CLASSPATH) TestClient.java

clean:
	-rm -f *.class

all: clean DatabaseServer.class FrontEndServer.class Client.class TestClient.class
